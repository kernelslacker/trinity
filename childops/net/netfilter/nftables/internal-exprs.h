 ...
 * internal-exprs.h
 *
 * Expression-family builder prototypes.  Split out of internal.h;
 * contents are moved verbatim.  Depends on internal-state.h for
 * base types (size_t, __u32).
 */

#ifndef CHILDOPS_NFTABLES_CHURN_INTERNAL_EXPRS_H
#define CHILDOPS_NFTABLES_CHURN_INTERNAL_EXPRS_H
...
#endif /* CHILDOPS_NFTABLES_CHURN_INTERNAL_EXPRS_H */
