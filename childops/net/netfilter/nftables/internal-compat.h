 ...
 * internal-compat.h
 *
 * UAPI fallback macros for nf_tables / netfilter / xfrm and the
 * xt/compat sweep + latch declarations.  Split out of internal.h;
 * contents are moved verbatim.  Depends on internal-state.h for the
 * base UAPI includes and struct nfnl_ctx forward declaration.
 */

#ifndef CHILDOPS_NFTABLES_CHURN_INTERNAL_COMPAT_H
#define CHILDOPS_NFTABLES_CHURN_INTERNAL_COMPAT_H
...
#endif /* CHILDOPS_NFTABLES_CHURN_INTERNAL_COMPAT_H */
