...
## Files (10 .c files + 1 internal header, ~3,216 LOC)
...
| signals-fault-handler.c | 677 | Child and main fault handlers — the M6 sigsetjmp site, `child_fault_handler()`, `main_fault_handler()`, beacon stamp, buglog redirect, guard-page attribution. |
