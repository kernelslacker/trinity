...
static const struct {
	...
	{ "lock_held_scribble",
	  offsetof(struct stats_s, diag.lock_held_scribble) },
	{ "rec_canary_stomped",
	  offsetof(struct stats_s, diag.rec_canary_stomped) },
	{ "rzs_blanket_reject",
	  offsetof(struct stats_s, diag.rzs_blanket_reject) },
	{ "retfd_blanket_reject",
	  offsetof(struct stats_s, diag.retfd_blanket_reject) },
	{ "arena_ptr_stale_caught_arg",
	  offsetof(struct stats_s, diag.arena_ptr_stale_caught_arg) },
	{ "arena_ptr_stale_caught_post_state",
	  offsetof(struct stats_s, diag.arena_ptr_stale_caught_post_state) },
	{ "execve_self_exec_blocked",
	  offsetof(struct stats_s, diag.execve_self_exec_blocked) },
	...
	{ "iouring_enter_mask_corrupt",
	  offsetof(struct stats_s, diag.iouring_enter_mask_corrupt) },
	{ "watchdog_sigalrm_clobbered",
	  offsetof(struct stats_s, watchdog_signal.sigalrm_clobbered) },
	{ "watchdog_sigxcpu_clobbered",
	  offsetof(struct stats_s, watchdog_signal.sigxcpu_clobbered) },
	{ "watchdog_sigalrm_reinstalled",
	  offsetof(struct stats_s, watchdog_signal.sigalrm_reinstalled) },
	{ "watchdog_sigxcpu_reinstalled",
	  offsetof(struct stats_s, watchdog_signal.sigxcpu_reinstalled) },
	{ "watchdog_sigalrm_unblocked",
	  offsetof(struct stats_s, watchdog_signal.sigalrm_unblocked) },
	{ "watchdog_sigxcpu_unblocked",
	  offsetof(struct stats_s, watchdog_signal.sigxcpu_unblocked) },
	...
	{ "stats_ring_corrupted",
	  offsetof(struct stats_s, diag.stats_ring_corrupted) },
	{ "stats_ring_overwritten",
	  offsetof(struct stats_s, diag.stats_ring_overwritten) },
	{ "fd_event_payload_corrupt",
	  offsetof(struct stats_s, fd.event_payload_corrupt) },
	{ "destroy_object_idx_corrupt",
	  offsetof(struct stats_s, diag.destroy_object_idx_corrupt) },
	{ "global_obj_uaf_caught",
	  offsetof(struct stats_s, diag.global_obj_uaf_caught) },
	...
	{ "chain_corpus_save_dup_shape",
	  offsetof(struct stats_s, chain_corpus.save_dup_shape) },
	{ "chain_corpus_save_unique_shape",
	  offsetof(struct stats_s, chain_corpus.save_unique_shape) },
	...
	{ "chain_restype_produced_epoll_fd",
	  offsetof(struct stats_s, chain_restype.produced[CHAIN_RESTYPE_EPOLL_FD]) },
	{ "chain_restype_produced_timerfd",
	  offsetof(struct stats_s, chain_restype.produced[CHAIN_RESTYPE_TIMERFD]) },
	{ "chain_restype_produced_eventfd",
	  offsetof(struct stats_s, chain_restype.produced[CHAIN_RESTYPE_EVENTFD]) },
	{ "chain_restype_produced_io_uring_fd",
	  offsetof(struct stats_s, chain_restype.produced[CHAIN_RESTYPE_IO_URING_FD]) },
	{ "chain_restype_produced_pidfd",
	  offsetof(struct stats_s, chain_restype.produced[CHAIN_RESTYPE_PIDFD]) },
	{ "chain_restype_produced_socket_tcp",
	  offsetof(struct stats_s, chain_restype.produced[CHAIN_RESTYPE_SOCKET_TCP]) },
	{ "chain_restype_produced_bpf_map_fd",
	  offsetof(struct stats_s, chain_restype.produced[CHAIN_RESTYPE_BPF_MAP_FD]) },
	{ "chain_restype_would_bias_epoll_fd",
	  offsetof(struct stats_s, chain_restype.would_bias[CHAIN_RESTYPE_EPOLL_FD]) },
	{ "chain_restype_would_bias_timerfd",
	  offsetof(struct stats_s, chain_restype.would_bias[CHAIN_RESTYPE_TIMERFD]) },
	{ "chain_restype_would_bias_eventfd",
	  offsetof(struct stats_s, chain_restype.would_bias[CHAIN_RESTYPE_EVENTFD]) },
	{ "chain_restype_would_bias_io_uring_fd",
	  offsetof(struct stats_s, chain_restype.would_bias[CHAIN_RESTYPE_IO_URING_FD]) },
	{ "chain_restype_would_bias_pidfd",
	  offsetof(struct stats_s, chain_restype.would_bias[CHAIN_RESTYPE_PIDFD]) },
	{ "chain_restype_would_bias_socket_tcp",
	  offsetof(struct stats_s, chain_restype.would_bias[CHAIN_RESTYPE_SOCKET_TCP]) },
	{ "chain_restype_would_bias_bpf_map_fd",
	  offsetof(struct stats_s, chain_restype.would_bias[CHAIN_RESTYPE_BPF_MAP_FD]) },
	{ "chain_restype_biased_epoll_fd",
	  offsetof(struct stats_s, chain_restype.biased[CHAIN_RESTYPE_EPOLL_FD]) },
	{ "chain_restype_biased_timerfd",
	  offsetof(struct stats_s, chain_restype.biased[CHAIN_RESTYPE_TIMERFD]) },
	{ "chain_restype_biased_eventfd",
	  offsetof(struct stats_s, chain_restype.biased[CHAIN_RESTYPE_EVENTFD]) },
	{ "chain_restype_biased_io_uring_fd",
	  offsetof(struct stats_s, chain_restype.biased[CHAIN_RESTYPE_IO_URING_FD]) },
	{ "chain_restype_biased_pidfd",
	  offsetof(struct stats_s, chain_restype.biased[CHAIN_RESTYPE_PIDFD]) },
	{ "chain_restype_biased_socket_tcp",
	  offsetof(struct stats_s, chain_restype.biased[CHAIN_RESTYPE_SOCKET_TCP]) },
	{ "chain_restype_biased_bpf_map_fd",
	  offsetof(struct stats_s, chain_restype.biased[CHAIN_RESTYPE_BPF_MAP_FD]) },
	{ "chain_restype_save_epoll_fd",
	  offsetof(struct stats_s, chain_restype.save[CHAIN_RESTYPE_EPOLL_FD]) },
	{ "chain_restype_save_timerfd",
	  offsetof(struct stats_s, chain_restype.save[CHAIN_RESTYPE_TIMERFD]) },
	{ "chain_restype_save_eventfd",
	  offsetof(struct stats_s, chain_restype.save[CHAIN_RESTYPE_EVENTFD]) },
	{ "chain_restype_save_io_uring_fd",
	  offsetof(struct stats_s, chain_restype.save[CHAIN_RESTYPE_IO_URING_FD]) },
	{ "chain_restype_save_pidfd",
	  offsetof(struct stats_s, chain_restype.save[CHAIN_RESTYPE_PIDFD]) },
	{ "chain_restype_save_socket_tcp",
	  offsetof(struct stats_s, chain_restype.save[CHAIN_RESTYPE_SOCKET_TCP]) },
	{ "chain_restype_save_bpf_map_fd",
	  offsetof(struct stats_s, chain_restype.save[CHAIN_RESTYPE_BPF_MAP_FD]) },
	{ "chain_restype_replay_win_epoll_fd",
	  offsetof(struct stats_s, chain_restype.replay_win[CHAIN_RESTYPE_EPOLL_FD]) },
	{ "chain_restype_replay_win_timerfd",
	  offsetof(struct stats_s, chain_restype.replay_win[CHAIN_RESTYPE_TIMERFD]) },
	{ "chain_restype_replay_win_eventfd",
	  offsetof(struct stats_s, chain_restype.replay_win[CHAIN_RESTYPE_EVENTFD]) },
	{ "chain_restype_replay_win_io_uring_fd",
	  offsetof(struct stats_s, chain_restype.replay_win[CHAIN_RESTYPE_IO_URING_FD]) },
	{ "chain_restype_replay_win_pidfd",
	  offsetof(struct stats_s, chain_restype.replay_win[CHAIN_RESTYPE_PIDFD]) },
	{ "chain_restype_replay_win_socket_tcp",
	  offsetof(struct stats_s, chain_restype.replay_win[CHAIN_RESTYPE_SOCKET_TCP]) },
	{ "chain_restype_replay_win_bpf_map_fd",
	  offsetof(struct stats_s, chain_restype.replay_win[CHAIN_RESTYPE_BPF_MAP_FD]) },
	{ "deferred_free_reject_misaligned",
	  offsetof(struct stats_s, deferred_free.reject_misaligned) },
	{ "deferred_free_reject_corrupt_shape",
	  offsetof(struct stats_s, deferred_free.reject_corrupt_shape) },
	{ "deferred_free_reject_non_heap",
	  offsetof(struct stats_s, deferred_free.reject_non_heap) },
	{ "deferred_free_reject_untracked",
	  offsetof(struct stats_s, deferred_free.reject_untracked) },
	{ "nested_scrub_reject_untracked",
	  offsetof(struct stats_s, deferred_free.nested_scrub_reject_untracked) },
	{ "deferred_free_reject_shared_region",
	  offsetof(struct stats_s, deferred_free.reject_shared_region) },
	{ "deferred_free_outstanding_vmas",
	  offsetof(struct stats_s, deferred_free.outstanding_vmas) },
	{ "deferred_free_vma_fallback_immediate",
	  offsetof(struct stats_s, deferred_free.vma_fallback_immediate) },
	{ "deferred_free_enomem_drain",
	  offsetof(struct stats_s, deferred_free.enomem_drain) },
	{ "deferred_free_rw_restore_enomem",
	  offsetof(struct stats_s, deferred_free.rw_restore_enomem) },
	...
	{ "deferred_free_double_admit_skip",
	  offsetof(struct stats_s, deferred_free.double_admit_skip) },
	{ "alloc_track_refresh_ring_owned_skip",
	  offsetof(struct stats_s, deferred_free.alloc_track_refresh_ring_owned_skip) },
	...
	{ "seal_fail_aborts",
	  offsetof(struct stats_s, syscall_dispatch.seal_fail_aborts) },
	{ "childop_dispatches",
	...
	{ "netlink_nested_attr_build_calls",
	  offsetof(struct stats_s, netlink_nested_attr_build_calls) },
	...
	{ "frontier_strategy_picks",
	  offsetof(struct stats_s, frontier.core.strategy_picks) },
	...
	{ "frontier_underflow_prevented",
	  offsetof(struct stats_s, frontier.core.underflow_prevented) },
	...
	{ "frontier_intervention_pulls",
	  offsetof(struct stats_s, frontier.core.intervention_pulls) },
	...
	{ "frontier_live_picks",
	  offsetof(struct stats_s, frontier.core.live_picks) },
	{ "frontier_silent_picks",
	  offsetof(struct stats_s, frontier.core.silent_picks) },
	...
	{ "frontier_decay_candidates",
	  offsetof(struct stats_s, frontier.cooldown.decay_candidates) },
	{ "frontier_decay_would_skip",
	  offsetof(struct stats_s, frontier.cooldown.decay_would_skip) },
	{ "frontier_silent_decay_live_rejects",
	  offsetof(struct stats_s, frontier.cooldown.silent_decay_live_rejects) },
	...
	{ "frontier_satcool_candidates",
	  offsetof(struct stats_s, frontier.saturation.satcool_candidates) },
	{ "frontier_satcool_would_skip",
	  offsetof(struct stats_s, frontier.saturation.satcool_would_skip) },
	{ "frontier_satcool_spared_arggen",
	  offsetof(struct stats_s, frontier.saturation.satcool_spared_arggen) },
	{ "frontier_satcool_spared_objproducer",
	  offsetof(struct stats_s, frontier.saturation.satcool_spared_objproducer) },
	...
	{ "frontier_barren_candidates",
	  offsetof(struct stats_s, frontier.saturation.barren_candidates) },
	{ "frontier_barren_would_skip",
	  offsetof(struct stats_s, frontier.saturation.barren_would_skip) },
	...
	{ "frontier_live_cool_candidates",
	  offsetof(struct stats_s, frontier.discriminator.live_cool_candidates) },
	{ "frontier_live_cool_would_skip",
	  offsetof(struct stats_s, frontier.discriminator.live_cool_would_skip) },
	{ "frontier_live_cool_spared_windowed",
	  offsetof(struct stats_s, frontier.discriminator.live_cool_spared_windowed) },
	{ "frontier_live_cool_spared_arggen",
	  offsetof(struct stats_s, frontier.discriminator.live_cool_spared_arggen) },
	{ "frontier_live_cool_spared_objproducer",
	  offsetof(struct stats_s, frontier.discriminator.live_cool_spared_objproducer) },
	...
	{ "frontier_live_cooldown_candidates",
	  offsetof(struct stats_s, frontier.cooldown.live_cooldown_candidates) },
	{ "frontier_live_would_skip",
	  offsetof(struct stats_s, frontier.cooldown.live_would_skip) },
	...
	{ "frontier_live_cooldown_decays",
	  offsetof(struct stats_s, frontier.cooldown.live_cooldown_decays) },
	...
	{ "frontier_live_decay_live_rejects",
	  offsetof(struct stats_s, frontier.cooldown.live_decay_live_rejects) },
	...
	{ "frontier_errno_decay_would_skip",
	  offsetof(struct stats_s, frontier.plateau.errno_decay_would_skip) },
	{ "frontier_errno_decay_live_rejects",
	  offsetof(struct stats_s, frontier.plateau.errno_decay_live_rejects) },
	{ "frontier_errno_decay_overlap_silent",
	  offsetof(struct stats_s, frontier.plateau.errno_decay_overlap_silent) },
	...
	{ "frontier_blend_samples",
	  offsetof(struct stats_s, frontier.plateau.blend_samples) },
	{ "frontier_blend_new_lower",
	  offsetof(struct stats_s, frontier.plateau.blend_new_lower) },
	{ "frontier_blend_new_higher",
	  offsetof(struct stats_s, frontier.plateau.blend_new_higher) },
	{ "frontier_blend_new_equal",
	  offsetof(struct stats_s, frontier.plateau.blend_new_equal) },
	{ "frontier_blend_old_weight_sum",
	  offsetof(struct stats_s, frontier.plateau.blend_old_weight_sum) },
	{ "frontier_blend_new_weight_sum",
	  offsetof(struct stats_s, frontier.plateau.blend_new_weight_sum) },
