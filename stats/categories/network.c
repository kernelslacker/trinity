...
static const struct stat_field pkt_builder_fields[] = {
	STAT_FIELD_SUB(pkt_builder, runs),
	STAT_FIELD_SUB(pkt_builder, setup_failed),
	STAT_FIELD_SUB(pkt_builder, built_ok),
	STAT_FIELD_SUB(pkt_builder, build_failed),
	STAT_FIELD_SUB(pkt_builder, mutated),
	STAT_FIELD_SUB(pkt_builder, truncated),
	...
	{ .name = "recipe_gretap_eth_ip4",
	  .offset = offsetof(struct stats_s, pkt_builder.per_recipe[1]) },
	{ .name = "recipe_raw_ip4_gretap_ip4",
	  .offset = offsetof(struct stats_s, pkt_builder.per_recipe[2]) },
	{ .name = "recipe_qinq_ip4",
	  .offset = offsetof(struct stats_s, pkt_builder.per_recipe[3]) },
