...
struct igmp_mld_source_churn_stats {
	...
	unsigned long msfilter41_get_ok;	 /* IP_MSFILTER (opt 41) getsockopt oracle attempted */
	unsigned long msfilter41_get_overrun;	 /* IP_MSFILTER oracle: guard hit or got_len > req_len */
	unsigned long msfilter41_get_rejected;	 /* IP_MSFILTER getsockopt returned <0 (errno logged) */
