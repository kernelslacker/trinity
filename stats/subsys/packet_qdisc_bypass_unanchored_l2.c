...
static const struct stat_field packet_qdisc_bypass_unanchored_l2_fields[] = {
	...
	STAT_FIELD_SUB(packet_qdisc_bypass_unanchored_l2, nlmsg_subscriber_live_macsec),
	STAT_FIELD_SUB(packet_qdisc_bypass_unanchored_l2, nlmsg_subscriber_silent_macsec),
	STAT_FIELD_SUB(packet_qdisc_bypass_unanchored_l2, nlmsg_subscriber_unarmed_macsec),
};
