...
static const struct stat_field igmp_mld_source_churn_fields[] = {
	...
	STAT_FIELD_SUB(igmp_mld_source_churn, msfilter41_get_ok),
	STAT_FIELD_SUB(igmp_mld_source_churn, msfilter41_get_overrun),
	STAT_FIELD_SUB(igmp_mld_source_churn, msfilter41_get_rejected),
