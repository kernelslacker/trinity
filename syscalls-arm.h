...
const struct syscalltable syscalls_arm[NR_ARM_SYSCALLS + 1] = {
		...
		{ .entry = &syscall_execve }, /*syscall_execve_wrapper */
		{ .entry = &syscall_chdir },
		...
		{ .entry = &syscall_ni_syscall },		/* was sys_iopl */
		{ .entry = &syscall_vhangup },
		{ .entry = &syscall_ni_syscall },
/* TODO:	{ .entry = &syscall_syscall },	 call a syscall */
		{ .entry = &syscall_wait4 },
		{ .entry = &syscall_swapoff },
		{ .entry = &syscall_sysinfo },
		{ .entry = &syscall_ipc },
		{ .entry = &syscall_fsync },
		{ .entry = &syscall_sigreturn },		/* sigreturn_wrapper */
		{ .entry = &syscall_clone },			/* clone_wrapper */
		...
		{ .entry = &syscall_ni_syscall },		/* was sys_get_kernel_syms */
		...
		{ .entry = &syscall_prctl },
		{ .entry = &syscall_rt_sigreturn },		/* rt_sigreturn_wrapper */
		...
		{ .entry = &syscall_ni_syscall },	/* sys_get_thread_area */
		...
		{ .entry = &syscall_statfs64 },			/* statfs64_wrapper */
