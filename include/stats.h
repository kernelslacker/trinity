...
struct stats_s {
	 ...
	 * written into it).  This is the per-message denominator for
	 ...
	 * Truncation rate = lost_align / build_calls. */
	 ...
	 * per-message counter, not per-attr; use build_calls as denominator.
	 * Truncation rate = lost_align / netlink_nested_attr_build_calls. */
