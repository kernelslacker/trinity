...
struct stats_s {
	...
	/*
	 * (formerly held lossless_op_total here; moved to per-child
	 * stats_ring.lossless_op_count to eliminate the MAP_SHARED
	 * hot-cacheline atomic and the wild-write scribble hazard)
	 */
	...
	/* xfrm_grammar accounting.  See stats/subsys/xfrm_grammar.h. */
	struct xfrm_grammar_stats xfrm_grammar __attribute__((aligned(64)));
