...
/* 295-402 are unassigned in asm-generic to sync with other archs */
/* 295 */	{ .entry = NULL },
/* 296 */	{ .entry = NULL },
/* 297 */	{ .entry = NULL },
/* 298 */	{ .entry = NULL },
...
/* 401 */	{ .entry = NULL },
/* 402 */	{ .entry = NULL },
/* 403-423 are time64 syscalls, only used on 32-bit archs */
/* 403 */	{ .entry = NULL },
/* 404 */	{ .entry = NULL },
/* 405 */	{ .entry = NULL },
/* 406 */	{ .entry = NULL },
...
/* 422 */	{ .entry = NULL },
/* 423 */	{ .entry = NULL },
/* 424 */	{ .entry = &syscall_pidfd_send_signal },
/* 425 */	{ .entry = &syscall_io_uring_setup },
/* 426 */	{ .entry = &syscall_io_uring_enter },
/* 427 */	{ .entry = &syscall_io_uring_register },
/* 428 */	{ .entry = &syscall_open_tree },
/* 429 */	{ .entry = &syscall_move_mount },
/* 430 */	{ .entry = &syscall_fsopen },
/* 431 */	{ .entry = &syscall_fsconfig },
/* 432 */	{ .entry = &syscall_fsmount },
/* 433 */	{ .entry = &syscall_fspick },
/* 434 */	{ .entry = &syscall_pidfd_open },
/* 435 */	{ .entry = &syscall_clone3 },
/* 436 */	{ .entry = &syscall_close_range },
/* 437 */	{ .entry = &syscall_openat2 },
/* 438 */	{ .entry = &syscall_pidfd_getfd },
/* 439 */	{ .entry = &syscall_faccessat2 },
/* 440 */	{ .entry = &syscall_process_madvise },
/* 441 */	{ .entry = &syscall_epoll_pwait2 },
/* 442 */	{ .entry = &syscall_mount_setattr },
/* 443 */	{ .entry = &syscall_quotactl_fd },
/* 444 */	{ .entry = &syscall_landlock_create_ruleset },
/* 445 */	{ .entry = &syscall_landlock_add_rule },
/* 446 */	{ .entry = &syscall_landlock_restrict_self },
/* 447 */	{ .entry = &syscall_memfd_secret },
/* 448 */	{ .entry = &syscall_process_mrelease },
/* 449 */	{ .entry = &syscall_futex_waitv },
/* 450 */	{ .entry = &syscall_set_mempolicy_home_node },
/* 451 */	{ .entry = &syscall_cachestat },
/* 452 */	{ .entry = &syscall_fchmodat2 },
/* 453 */	{ .entry = &syscall_map_shadow_stack },
/* 454 */	{ .entry = &syscall_futex_wake },
/* 455 */	{ .entry = &syscall_futex_wait },
/* 456 */	{ .entry = &syscall_futex_requeue },
/* 457 */	{ .entry = &syscall_statmount },
/* 458 */	{ .entry = &syscall_listmount },
/* 459 */	{ .entry = &syscall_lsm_get_self_attr },
/* 460 */	{ .entry = &syscall_lsm_set_self_attr },
/* 461 */	{ .entry = &syscall_lsm_list_modules },
/* 462 */	{ .entry = &syscall_mseal },
/* 463 */	{ .entry = &syscall_setxattrat },
/* 464 */	{ .entry = &syscall_getxattrat },
/* 465 */	{ .entry = &syscall_listxattrat },
/* 466 */	{ .entry = &syscall_removexattrat },
/* 467 */	{ .entry = &syscall_open_tree_attr },
/* 468 */	{ .entry = &syscall_file_getattr },
