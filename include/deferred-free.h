 ...
 * when an already-tracked pointer is re-referenced (mm/maps-lifecycle.c dedup-skip,
 ...
 * for the metadata regions, NONE for the ring).  MUST run at
 ...
 * currently sealed (rw_open == false on all regions).  Compiled out of
