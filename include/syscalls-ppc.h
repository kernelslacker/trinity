...
struct syscalltable syscalls_ppc[] = {
	...
	{ .entry = &syscall_ni_syscall }, // removed "bdflush" syscall
	{ .entry = &syscall_sysfs },
	...
	{ .entry = &syscall_ni_syscall }, // removed "_sysctl" syscall
	{ .entry = &syscall_mlock },
	...
	{ .entry = &syscall_poll },
	{ .entry = &syscall_ni_syscall }, // removed "nfsservctl" syscall
	...
	{ .entry = &syscall_ni_syscall }, /* ppc64_swapcontext, ppc-specific */
	...
	{ .entry = &syscall_rtas },
	{ .entry = &syscall_ni_syscall }, /* debug_setcontext, ppc-specific */
	{ .entry = &syscall_ni_syscall },
	...
	{ .entry = &syscall_ni_syscall }, /* spu_run, Cell/SPE only, long dead */
	{ .entry = &syscall_ni_syscall }, /* spu_create, Cell/SPE only, long dead */
	...
	{ .entry = &syscall_ni_syscall }, /* subpage_prot, ppc64-specific */
