...
static const int ether_types[] = {
	...
	ETH_P_ATALK, ETH_P_AARP, ETH_P_8021Q,
	ETH_P_IPV6, ETH_P_PAUSE, ETH_P_SLOW, ETH_P_WCCP,
	...
	ETH_P_TR_802_2, ETH_P_MOBITEX, ETH_P_CONTROL,
	ETH_P_HDLC, ETH_P_ARCNET, ETH_P_DSA,
	ETH_P_TRAILER, ETH_P_PHONET, ETH_P_IEEE802154, ETH_P_CAIF,
};
...
{
	return ether_types[rnd_modulo_u32(NR_ETHER_TYPES)];
}
