...
struct syscalltable syscalls_ppc[NR_SYSCALLS+1] = {
	...
	{ .entry = &syscall_alarm },
	{ .entry = &syscall_ni_syscall.h }, // was OLDSYS(fstat)
	{ .entry = &syscall_pause },
	{ .entry = &syscall_utime },
	{ .entry = &syscall_ni_syscall.h }, // (old stty syscall holder).h
	{ .entry = &syscall_ni_syscall.h }, // (old gtty syscall holder).h
	{ .entry = &syscall_access },
	{ .entry = &syscall_nice },
	{ .entry = &syscall_ni_syscall.h }, // old ftime syscall holder
	{ .entry = &syscall_sync },
	{ .entry = &syscall_kill },
	...
	{ .entry = &syscall_pipe },
	{ .entry = &syscall_times },
	{ .entry = &syscall_ni_syscall.h }, // (old prof syscall holder)
	{ .entry = &syscall_brk },
	...
	{ .entry = &syscall_acct },
	{ .entry = &syscall_umount.h },		// recycled never used phys()
	{ .entry = &syscall_ni_syscall.h },	// old lock syscall holder
	{ .entry = &syscall_ioctl },
	{ .entry = &syscall_fcntl },
	{ .entry = &syscall_ni_syscall.h },	// old mpx syscall holder
	{ .entry = &syscall_setpgid },
	{ .entry = &syscall_ni_syscall.h },	// old ulimit syscall holder
	...
	{ .entry = &syscall_ni_syscall.h }, // was COMPAT_SYS(old_getrlimit)
	...
	{ .entry = &syscall_ni_syscall.h }, // old profil syscall holder
	...
	{ .entry = &syscall_uname },
	{ .entry = &syscall_ni_syscall.h }, // (105)"
	{ .entry = &syscall_vhangup },
	{ .entry = &syscall_ni_syscall.h }, // old 'idle' system call?
	{ .entry = &syscall_ni_syscall.h }, // 108
	{ .entry = &syscall_wait4 },
	...
	{ .entry = &syscall_ni_syscall.h }, // old create module
	{ .entry = &syscall_init_module },
	{ .entry = &syscall_delete_module },
	{ .entry = &syscall_ni_syscall.h }, // old get_kernel_syms
	...
	{ .entry = &syscall_ni_syscall.h }, // Old sys_query_module
	{ .entry = &syscall_poll },
	...
	{ .entry = &syscall_ni_syscall.h }, // reserved for streams1
	{ .entry = &syscall_ni_syscall.h }, // reserved for streams2
	{ .entry = &syscall_vfork },
	...
	{ .entry = &syscall_ni_syscall.h }, // TODO: pciconfig_read
	{ .entry = &syscall_ni_syscall.h }, // TODO: pciconfig_write
	{ .entry = &syscall_ni_syscall.h }, // TODO: pciconfig_iobase
	{ .entry = &syscall_ni_syscall.h }, // 201
	...
	{ .entry = &syscall_ni_syscall.h }, // TODO: ppc64_swapcontext
	...
	{ .entry = &syscall_rtas },
	{ .entry = &syscall_ni_syscall.h }, // TODO: debug_setcontext
	{ .entry = &syscall_ni_syscall },
	...
	{ .entry = &syscall_ni_syscall.h }, // TODO: spu_run
	{ .entry = &syscall_ni_syscall.h }, // TODO: spu_create
	...
	{ .entry = &syscall_ni_syscall.h }, // TODO: subpage_prot
	...
	{ .entry = &syscall_perf_counter_open },
