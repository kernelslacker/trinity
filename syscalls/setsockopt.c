...
static socklen_t build_sctp_assocparams(void *buf)
{
...
static socklen_t build_sctp_assoc_value(void *buf)
{
...
static socklen_t build_sctp_sndrcvinfo(void *buf)
{
	memset(buf, 0, sizeof(struct sctp_sndrcvinfo));
	return sizeof(struct sctp_sndrcvinfo);
}

static socklen_t build_sctp_events(void *buf)
{
...
static socklen_t build_sctp_sackinfo(void *buf)
{
...
static socklen_t build_sctp_default_prinfo(void *buf)
{
...
static socklen_t build_sctp_stream_value(void *buf)
{
...
static socklen_t build_sctp_paddrthlds_v2(void *buf)
{
	memset(buf, 0, sizeof(struct sctp_paddrthlds_v2));
	return sizeof(struct sctp_paddrthlds_v2);
}

static socklen_t build_sctp_udpencaps(void *buf)
{
...
static socklen_t build_sctp_probeinterval(void *buf)
{
