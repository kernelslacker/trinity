 ...
 * allocator.
 */
static struct ioring_register_payload ioring_reg_file_alloc_range_payload(void)
{
	struct ioring_register_payload p;
 ...
 * <time.h> enum drift.
 */
static struct ioring_register_payload ioring_reg_clock_payload(void)
{
 ...
 */
static struct ioring_register_payload ioring_reg_ring_fds_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_pbuf_ring_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_pbuf_status_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_zcrx_ifq_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_resize_rings_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_mem_region_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_rsrc_register_payload(unsigned int opcode)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_rsrc_update_payload(unsigned int opcode)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_query_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_zcrx_ctrl_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_clone_buffers_payload(struct io_uringobj *ring)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_sync_cancel_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_send_msg_ring_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_bpf_filter_payload(void)
{
	struct ioring_register_payload p;
 ...
 */
static struct ioring_register_payload ioring_reg_default_payload(void)
{
	struct ioring_register_payload p;
	void *buf;
